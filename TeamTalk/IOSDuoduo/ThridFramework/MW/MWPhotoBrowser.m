...
- (void)viewDidLoad {
    ...
    self.topview = [[UIView alloc] initWithFrame:CGRectMake(0, 0,10000, 45)];
    [self.topview setBackgroundColor:RGBA(0, 0, 0, 0.7)];
    [_pagingScrollView addSubview:self.topview];
    // Toolbar
	...
	for (NSUInteger index = (NSUInteger)iFirstIndex; index <= (NSUInteger)iLastIndex; index++) {
		if (![self isDisplayingPageForIndex:index]) {
            ...
            if (self.displaySelectionButtons) {
                ...
                [selectedButton setImage:[UIImage imageNamed:@"dd_preview_unselected"] forState:UIControlStateNormal];
                [selectedButton setImage:[UIImage imageNamed:@"dd_preview_select"] forState:UIControlStateSelected];
...
-(void)setHiddenStatusBar:(BOOL)isHidden
{
